...
def create_mask_overlay(original_img, masks, scores):
    ...
    cv2.putText(overlayed, text, (10, 40), cv2.FONT_HERSHEY_SIMPLEX, font_scale, (0, 255, 0), font_thickness)
    cv2.putText(overlayed, text1, (10, 60), cv2.FONT_HERSHEY_SIMPLEX, font_scale, (0,255, 0), font_thickness)
